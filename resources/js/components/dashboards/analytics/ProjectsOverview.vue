...
<template>
  <div class="col-span-12 lg:col-span-8 box mb-4 xxxl:mb-6 overflow-x-hidden">
    ...
    <VueApexCharts :height="350" width="100%" :series="chartData.series" :options="chartData" type="area" />
  </div>
</template>
