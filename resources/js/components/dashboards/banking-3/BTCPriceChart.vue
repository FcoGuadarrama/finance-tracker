...
<template>
  <div class="col-span-12 lg:col-span-8 xxl:col-span-9 box overflow-x-hidden">
    ...
    <VueApexCharts :height="350" width="100%" :series="chartData.series" :options="chartData" type="line" />
  </div>
</template>
