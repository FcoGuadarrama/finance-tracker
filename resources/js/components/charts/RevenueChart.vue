...
<template>
  <div class="box col-span-12 lg:col-span-6 overflow-x-hidden">
    <p class="pb-4 mb-4 xl:pb-6 xl:mb-6 bb-dashed font-medium">Monthly Revenue</p>
    <VueApexCharts :options="candlestick" :series="candlestick.series" type="candlestick" :height="320" width="100%" />
  </div>
</template>
