...
<template>
  <div class="relative" ref="target">
    <button @click="isOpen = !isOpen" class="flex gap-1 p-2 sm:p-3 rounded-full bg-primary/5 dark:bg-bg3">
      <IconWorld :size="20" />
      <IconChevronDown :size="22" />
    </button>
    <div
      class="bg-n0 border dark:border-n500 ltr:origin-top-right rtl:origin-top-left dark:bg-n800 rounded-md ltr:right-0 rtl:left-0 shadow-lg absolute top-full duration-300"
