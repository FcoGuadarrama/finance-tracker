...
<template>
  <div class="col-span-12 xl:col-span-6 box">
    <p class="font-medium pb-6 bb-dashed">Live Users By Country</p>
    <vuevectormap width="100%" :height="450" :options="options"> </vuevectormap>
  </div>
</template>
